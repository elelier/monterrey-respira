...
Este documento conserva cambios históricos de una etapa anterior del proyecto. No describe el runtime vigente.
...
- Simplificada la configuración de Netlify del flujo retirado
